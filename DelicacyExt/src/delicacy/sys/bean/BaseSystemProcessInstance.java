...
public class BaseSystemProcessInstance extends GenericBase implements BaseFactory<BaseSystemProcessInstance>, Comparable<BaseSystemProcessInstance> 
{


	public static BaseSystemProcessInstance newInstance(){
		return new BaseSystemProcessInstance();
	}

	@Override
	public BaseSystemProcessInstance make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,流程类型,业务编码,业务名称,流程编码,活动实列编码,,创建人,创建时间,完成时间,删除状态  0未删除    1已删除,流程走完之后，是否执行了其他操作   0未执行   1已执行,组织机构代码";
	...
	public void cloneCopy(BaseSystemProcessInstance __bean){
	...
	@Override
	public int compareTo(BaseSystemProcessInstance o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSystemProcessInstance o = (BaseSystemProcessInstance)obj;
