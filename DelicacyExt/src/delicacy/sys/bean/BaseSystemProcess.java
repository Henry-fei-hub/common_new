...
public class BaseSystemProcess extends GenericBase implements BaseFactory<BaseSystemProcess>, Comparable<BaseSystemProcess> 
{
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,流程类型编码,归属部门,归属部门(包括下级部门),创建人,创建时间,流程名称,是否会签,归档部门,归档职务,描述,是否可用,组织机构代码";
	...
	public boolean equals(Object obj) {
		...
		if(!Objects.equals(this.__include_department_id, o.getIncludeDepartmentId())) return false;
		...
		if(!Objects.equals(this.__hold_department_id, o.getHoldDepartmentId())) return false;
		if(!Objects.equals(this.__hold_duty_id, o.getHoldDutyId())) return false;
		if(!Objects.equals(this.__description, o.getDescription())) return false;
		if(!Objects.equals(this.__enable, o.getEnable())) return false;
	...
	public java.lang.String toJSONString() {
		...
		if(getIncludeDepartmentId() != null) sb.append(__wrapNumber(count++, "includeDepartmentId", getIncludeDepartmentId()));
		...
		if(getHoldDepartmentId() != null) sb.append(__wrapNumber(count++, "holdDepartmentId", getHoldDepartmentId()));
		if(getHoldDutyId() != null) sb.append(__wrapNumber(count++, "holdDutyId", getHoldDutyId()));
		if(getDescription() != null) sb.append(__wrapString(count++, "description", getDescription()));
		if(getEnable() != null) sb.append(__wrapBoolean(count++, "enable", getEnable()));
	...
	public Map<String, Object> toMap() {
		...
		if(getIncludeDepartmentId() != null) res.put("includeDepartmentId", getIncludeDepartmentId());
		...
		if(getCountersign() != null) res.put("countersign", getCountersign());
		if(getHoldDepartmentId() != null) res.put("holdDepartmentId", getHoldDepartmentId());
		if(getHoldDutyId() != null) res.put("holdDutyId", getHoldDutyId());
		if(getDescription() != null) res.put("description", getDescription());
		if(getEnable() != null) res.put("enable", getEnable());
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("includeDepartmentId")) != null) setIncludeDepartmentId(__getInt(val)); 
		...
		if((val = values.get("holdDepartmentId")) != null) setHoldDepartmentId(__getInt(val)); 
		if((val = values.get("holdDutyId")) != null) setHoldDutyId(__getInt(val)); 
		if((val = values.get("description")) != null) setDescription(__getString(val));
		if((val = values.get("enable")) != null) setEnable(__getBoolean(val));
