...
public class SystemProcessActivityHandler implements GenericDao {
	...
	public static boolean isSystemProcessActivityExists(BaseSystemProcessActivity bean, String additional ) throws Exception {
	...
	public static int countSystemProcessActivity(BaseSystemProcessActivity bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseSystemProcessActivity> querySystemProcessActivity(BaseSystemProcessActivity bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		SystemProcessActivity dao = new SystemProcessActivity();
		setConditions(bean, dao);
