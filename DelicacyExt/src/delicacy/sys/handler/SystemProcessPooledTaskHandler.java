...
public class SystemProcessPooledTaskHandler implements GenericDao {
	...
	public static boolean isSystemProcessPooledTaskExists(BaseSystemProcessPooledTask bean, String additional ) throws Exception {
	...
	public static int countSystemProcessPooledTask(BaseSystemProcessPooledTask bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseSystemProcessPooledTask> querySystemProcessPooledTask(BaseSystemProcessPooledTask bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		SystemProcessPooledTask dao = new SystemProcessPooledTask();
		setConditions(bean, dao);
