...
public class SystemProcessHandler implements GenericDao {
	...
	public static boolean isSystemProcessExists(BaseSystemProcess bean, String additional ) throws Exception {
	...
	public static int countSystemProcess(BaseSystemProcess bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseSystemProcess> querySystemProcess(BaseSystemProcess bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		SystemProcess dao = new SystemProcess();
		setConditions(bean, dao);
