...
import delicacy.sys.dao.SystemProcessDepartment;
...
public class SystemProcessDepartmentHandler implements GenericDao {
	...
	public static boolean isSystemProcessDepartmentExists(BaseSystemProcessDepartment bean, String additional ) throws Exception {
	...
	public static int countSystemProcessDepartment(BaseSystemProcessDepartment bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseSystemProcessDepartment> querySystemProcessDepartment(BaseSystemProcessDepartment bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		SystemProcessDepartment dao = new SystemProcessDepartment();
		setConditions(bean, dao);
