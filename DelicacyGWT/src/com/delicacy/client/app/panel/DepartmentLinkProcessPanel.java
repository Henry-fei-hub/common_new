...
import com.delicacy.client.department.datasource.DSSystemProcessDepartment;
...
public class DepartmentLinkProcessPanel extends AbstractWizadPage implements HasHandlers {
	...
	private SystemProcessListPanel leftPanel;
	...
	public DepartmentLinkProcessPanel() {
		setBorder(BORDER_STYLE);
		grid = new DelicacyListGrid(true);
		int idx = 0;
		ListGridField[] fields = new ListGridField[4];
		fields[idx] = new ListGridField("processDepartmentId");
		fields[idx].setHidden(true);
		idx++;
		fields[idx] = new ListGridField("processId");
		KeyValueManager.loadValueMap("system_processes", fields[idx]);
		idx++;
		...
		grid.setDataSource(DSSystemProcessDepartment.getInstance());
	...
	public Map getValuesAsMap() {
		...
		MapUtils.convertRecordToMap(grid.getDataSource(), rows, param, "detailSystemProcessDepartment");
		return param;
	}
	...
	public SystemProcessListPanel getLeftPanel() {
		return leftPanel;
	}

	public void setLeftPanel(SystemProcessListPanel leftPanel) {
