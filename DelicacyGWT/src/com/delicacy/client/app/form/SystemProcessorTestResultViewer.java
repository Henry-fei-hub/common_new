...
public class SystemProcessorTestResultViewer extends AbstractDetailViewer
{
	...
	public SystemProcessorTestResultViewer() {
	}
	...
	public void load() {
		...
		params.put("processorTestResultId", getBusinessId());
		DBDataSource.callOperation("NQ_SystemProcessorTestResult", "find", new DSCallback() {
			@Override
