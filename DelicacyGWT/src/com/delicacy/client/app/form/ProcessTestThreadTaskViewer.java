...
public class ProcessTestThreadTaskViewer extends AbstractDetailViewer
{
	...
	public ProcessTestThreadTaskViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ProcessTestThreadTask", "find", new DSCallback() {
			@Override
