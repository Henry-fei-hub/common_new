...
public class SsystemprocessattentionpeorHandelPanel extends AbstractSearchPanel {
    ...
    public static class Factory implements PanelFactory {
        ...
        public Canvas create() {
            SsystemprocessattentionpeorHandelPanel cm = new SsystemprocessattentionpeorHandelPanel();
            id = cm.getID();
            return cm;
        }
    ...
    public void showDetail() {
        GWT.runAsync(new RunAsyncCallback() {
            ...
            public void onSuccess() {
                ...
                Reimbursement.saveButton.setDisabled(true);
                Reimbursement.show();
            }
        });
    }
    ...
    public boolean checkSearchCriteria(Map criteria) {
        ...
        kv.put("key", "spa.status = 1");
        kv.put("value", "spa.status > 1");
        keyvalues.add(kv);
