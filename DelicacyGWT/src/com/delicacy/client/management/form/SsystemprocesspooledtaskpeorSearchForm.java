...
public class SsystemprocesspooledtaskpeorSearchForm extends SearchForm
{
	...
	public SsystemprocesspooledtaskpeorSearchForm() {
		setWidth100();
		setHeight100();
//		setDataSource(CDSsystemprocesspooledtaskpeor.getInstance());
