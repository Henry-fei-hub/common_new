...
public class MobileFunctionViewer extends AbstractDetailViewer
{




	public MobileFunctionViewer() {
	}
	...
	public void load() {
		...
		params.put("functionId", getBusinessId());
		DBDataSource.callOperation("ST_MobileFunction", "find", new DSCallback() {
			@Override
