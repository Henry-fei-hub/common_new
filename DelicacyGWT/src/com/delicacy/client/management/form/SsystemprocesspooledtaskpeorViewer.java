...
public class SsystemprocesspooledtaskpeorViewer extends AbstractDetailViewer
{
	...
	public SsystemprocesspooledtaskpeorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Ssystemprocesspooledtaskpeor", "find", new DSCallback() {
			@Override
