...
public class SsystemprocessinstanceactivitypeorSearchForm extends SearchForm
{
	...
	public SsystemprocessinstanceactivitypeorSearchForm() {
		setWidth100();
		setHeight100();
//		setDataSource(CDSsystemprocessinstanceactivitypeor.getInstance());
