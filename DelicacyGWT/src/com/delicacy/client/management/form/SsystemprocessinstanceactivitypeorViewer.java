...
public class SsystemprocessinstanceactivitypeorViewer extends AbstractDetailViewer
{
	...
	public SsystemprocessinstanceactivitypeorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Ssystemprocessinstanceactivitypeor", "find", new DSCallback() {
			@Override
