...
public class SsystemprocessattentionpeorViewer extends AbstractDetailViewer
{
	...
	public SsystemprocessattentionpeorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Ssystemprocessattentionpeor", "find", new DSCallback() {
			@Override
