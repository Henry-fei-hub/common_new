...
public class SsystemprocessinstanceorViewer extends AbstractDetailViewer
{
	...
	public SsystemprocessinstanceorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Ssystemprocessinstanceor", "find", new DSCallback() {
			@Override
