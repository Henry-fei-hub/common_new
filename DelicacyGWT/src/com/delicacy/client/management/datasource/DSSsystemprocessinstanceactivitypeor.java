...
public class DSSsystemprocessinstanceactivitypeor extends DBDataSource
{


	public static DSSsystemprocessinstanceactivitypeor instance = null;

	public static DSSsystemprocessinstanceactivitypeor getInstance() {
		if(instance == null) {
			instance = new DSSsystemprocessinstanceactivitypeor("DSSsystemprocessinstanceactivitypeor");
		}
		return instance;
	}
	...
	public DSSsystemprocessinstanceactivitypeor(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("Ssystemprocessinstanceactivitypeor");
		...
		instanceActivityCreateTimeField = new DataSourceDateTimeField("instanceActivityCreateTime", "创建时间");
		instanceActivityCreateTimeField.setRequired(false);
		instanceActivityCreateTimeField.setHidden(false);


		instanceActivityStartTimeField = new DataSourceDateTimeField("instanceActivityStartTime", "开始活动时间");
		...
		setFields(processInstanceActivityIdField, processTypeField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, employeeIdField, operateTimeField, processCommentField, statusField);
	}
