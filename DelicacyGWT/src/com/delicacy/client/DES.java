...
//		}
    ...
    public String ENC(String content) throws UnsupportedEncodingException {
        byte[] ens = DesEncrypt(content.getBytes("UTF-8"), 1);
        return Base64Utils.toBase64(ens);
    }

    public String DEC(String content) throws UnsupportedEncodingException {
        byte[] ens = Base64Utils.fromBase64(content);
        byte[] ens1 = DesEncrypt(ens, 0);
        return new String(ens1, "UTF-8");
    }
