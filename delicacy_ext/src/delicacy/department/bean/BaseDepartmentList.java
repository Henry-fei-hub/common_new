...
public class BaseDepartmentList extends GenericBase implements BaseFactory<BaseDepartmentList>, Comparable<BaseDepartmentList> 
{


	public static BaseDepartmentList newInstance(){
		return new BaseDepartmentList();
	}

	@Override
	public BaseDepartmentList make(){
		BaseDepartmentList b = new BaseDepartmentList();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "部门编码,部门名称,部门名称缩写,部门负责编码,部门负责人姓名,上级部门,是否有效,original_id,板块,总部, 2业务部门,微信部门编码,企业邮箱部门编码,ECMC部门编码,0 未删除  1 已删除,is_enable";
	...
	public java.util.List<BaseSystemProcessDepartment> getDetailSystemProcessDepartment() {
		return this.__detailSystemProcessDepartment;
	}

	public void setDetailSystemProcessDepartment( java.util.List<BaseSystemProcessDepartment> value ) {
		this.__detailSystemProcessDepartment = value;
	}

	public java.util.List<BaseDepartmentRole> getDetailDepartmentRole() {
		return this.__detailDepartmentRole;
	}

	public void setDetailDepartmentRole( java.util.List<BaseDepartmentRole> value ) {
		this.__detailDepartmentRole = value;
	}

	public void cloneCopy(BaseDepartmentList __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strDepartmentType = delicacy.system.executor.SelectValueCache.getSelectValue("system_dictionary_93", String.valueOf(getDepartmentType()));
	...
	@Override
	public int compareTo(BaseDepartmentList o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseDepartmentList o = (BaseDepartmentList)obj;
	...
	public java.lang.String toJSONString() {
		...
		if(getDetailSystemProcessDepartment() != null)  sb.append(__wrapList(count++, "detailSystemProcessDepartment", getDetailSystemProcessDepartment()));
		if(getDetailDepartmentRole() != null)  sb.append(__wrapList(count++, "detailDepartmentRole", getDetailDepartmentRole()));
		return sb.toString();
	}
	...
	public Map<String, Object> toMap() {
		...
		if(getAbbreviation() != null) res.put("abbreviation", getAbbreviation());
		if(getManagerId() != null) res.put("managerId", getManagerId());
		if(getManagerName() != null) res.put("managerName", getManagerName());
		if(getParentId() != null) res.put("parentId", getParentId());
		if(getEnabled() != null) res.put("enabled", getEnabled());
		if(getOriginalId() != null) res.put("originalId", getOriginalId());
		...
		if(getWeixinDepartmentId() != null) res.put("weixinDepartmentId", getWeixinDepartmentId());
		if(getEmailDepartmentId() != null) res.put("emailDepartmentId", getEmailDepartmentId());
		if(getEcmcDepartmentId() != null) res.put("ecmcDepartmentId", getEcmcDepartmentId());
	...
	protected java.util.List<BaseSystemProcessDepartment> __detailSystemProcessDepartment = null;
	protected java.util.List<BaseDepartmentRole> __detailDepartmentRole = null;
}
