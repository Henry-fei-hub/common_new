...
public class BaseSapplicationaaor extends GenericBase implements BaseFactory<BaseSapplicationaaor>, Comparable<BaseSapplicationaaor> 
{


	public static BaseSapplicationaaor newInstance(){
		return new BaseSapplicationaaor();
	}

	@Override
	public BaseSapplicationaaor make(){
		BaseSapplicationaaor b = new BaseSapplicationaaor();
		return b;
	}
	...
	public void cloneCopy(BaseSapplicationaaor __bean){
	...
	@Override
	public int compareTo(BaseSapplicationaaor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSapplicationaaor o = (BaseSapplicationaaor)obj;
