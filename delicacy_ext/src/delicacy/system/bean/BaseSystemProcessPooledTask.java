...
public class BaseSystemProcessPooledTask extends GenericBase implements BaseFactory<BaseSystemProcessPooledTask>, Comparable<BaseSystemProcessPooledTask> 
{
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,流程类型,业务编码,业务名称,活动编码,流程编码,流程实列编码,返回数据集,节点类型 0 - 开始 1 - 结束 2 - 审批 3 - 处理 4 - 知会,附加节点，说明节点是预定义的节点还是动态加的节点， 0 - 正常定义的节点， 1 - 申请人或者审批人加的处理人或者审批人,当前流程实例节点的内部编码,当前流程实例节点的内部编码,流程实例节点创建时间,流程实例节点开始处于活动时间,处理人,操作时间,提交意见,状态,删除状态  0未删除    1已删除,消息状态 0  未发送 1  已发送";
