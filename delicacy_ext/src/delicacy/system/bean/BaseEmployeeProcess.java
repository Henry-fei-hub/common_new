...
public class BaseEmployeeProcess extends GenericBase implements BaseFactory<BaseEmployeeProcess>, Comparable<BaseEmployeeProcess> {

    public static BaseEmployeeProcess newInstance() {
        return new BaseEmployeeProcess();
    }

    @Override
    public BaseEmployeeProcess make() {
        BaseEmployeeProcess b = new BaseEmployeeProcess();
        return b;
    }
    ...
    public void cloneCopy(BaseEmployeeProcess __bean) {
    ...
    @Override
    public int compareTo(BaseEmployeeProcess o) {
    ...
    public boolean equals(Object obj) {
        ...
        final BaseEmployeeProcess o = (BaseEmployeeProcess) obj;
