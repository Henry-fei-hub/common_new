...
public class SystemProcessType extends AbstractTable<BaseSystemProcessType>
{
	...
	protected final void initColumnNames()  throws java.sql.SQLException {
		...
		__column_names[8] = BaseSystemProcessType.CS_APPLICATION_ID;
	...
	public void setDataFromCSV(String csvLine, String names){
		...
		if((num = __inputNames[count++]) != null) {
			val = values[num];
			if(val != null && !val.isEmpty()) setProcessTypeId(GenericBase.__getInt(val));
		}
		if((num = __inputNames[count++]) != null) {
			val = values[num];
			if(val != null && !val.isEmpty()) setProcessTypeName(GenericBase.__getString(val));
		}
		if((num = __inputNames[count++]) != null) {
			val = values[num];
		...
		if((num = __inputNames[count++]) != null) {
			val = values[num];
			if(val != null && !val.isEmpty()) setProcessExecuteName(GenericBase.__getString(val));
		}
		if((num = __inputNames[count++]) != null) {
			val = values[num];
			if(val != null && !val.isEmpty()) setIsEnable(GenericBase.__getBoolean(val));
		}
		if((num = __inputNames[count++]) != null) {
			val = values[num];
			if(val != null && !val.isEmpty()) setParentProcessTypeId(GenericBase.__getInt(val));
		}
		if((num = __inputNames[count++]) != null) {
			val = values[num];
			if(val != null && !val.isEmpty()) setIcon(GenericBase.__getString(val));
		}
		if((num = __inputNames[count++]) != null) {
			val = values[num];
			if(val != null && !val.isEmpty()) setIsAttendance(GenericBase.__getBoolean(val));
		}
		if((num = __inputNames[count++]) != null) {
			val = values[num];
	...
	public void setProcessTypeIdExpression(String val) {
	...
	public void setProcessTypeNameExpression(String val) {
	...
	public void setProcessExecuteNameExpression(String val) {
	...
	public void setIsEnableExpression(String val) {
	...
	public void setParentProcessTypeIdExpression(String val) {
	...
	public void setIsAttendanceExpression(String val) {
