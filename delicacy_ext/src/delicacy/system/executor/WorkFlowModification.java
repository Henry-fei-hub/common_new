...
public class WorkFlowModification implements GenericProcessor {
    ...
    public String execute(String source, int operator) throws Exception {
        ...
        if (processInformation.getAdditionalApprovalment() != null) {
            ia = ProcessUtil.createInstanceActivity(definition.getProcessId(), processInstance.getProcessInstanceId(),
                    definition.getProcessTypeId(), businessId.getBusinessId(), businessId.getBusinessSubject());
        ...
        if (!completed) {
            ...
            while (true) {
                ...
                ia = ProcessUtil.createInstanceActivity(definition.getProcessId(),
                        ...
                        businessId.getBusinessId(), businessId.getBusinessSubject());
        ...
        if (isChanged) {
            ...
            ProcessUtil.saveInstanceActivity(instanceActivities, attentions, tasks);
        }
