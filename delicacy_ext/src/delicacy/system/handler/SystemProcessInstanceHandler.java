...
public class SystemProcessInstanceHandler implements GenericDao {
	...
	public static boolean isSystemProcessInstanceExists( delicacy.system.bean.BaseSystemProcessInstance bean, String additional ) throws Exception {
	...
	public static int countSystemProcessInstance( delicacy.system.bean.BaseSystemProcessInstance bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseSystemProcessInstance> querySystemProcessInstance( delicacy.system.bean.BaseSystemProcessInstance bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		SystemProcessInstance dao = new SystemProcessInstance();
		setConditions(bean, dao);
