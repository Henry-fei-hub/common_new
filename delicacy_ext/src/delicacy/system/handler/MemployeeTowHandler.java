...
import delicacy.system.query.QueryMemployeeTow;
...
public class MemployeeTowHandler implements GenericQuery,  GenericDownloadProcessor {

	private static final Logger __logger = Logger.getLogger(MemployeeTowHandler.class);
	...
	public static BaseCollection<BaseMemployeeNew> executeQueryMemployeeNew(ConditionMemployeeNew c, KeyValuePair[] replacements ) throws Exception {
		QueryMemployeeTow dao = new QueryMemployeeTow();
