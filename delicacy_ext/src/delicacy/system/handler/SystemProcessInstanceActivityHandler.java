...
public class SystemProcessInstanceActivityHandler implements GenericDao {
	...
	public static boolean isSystemProcessInstanceActivityExists( delicacy.system.bean.BaseSystemProcessInstanceActivity bean, String additional ) throws Exception {
	...
	public static int countSystemProcessInstanceActivity( delicacy.system.bean.BaseSystemProcessInstanceActivity bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseSystemProcessInstanceActivity> querySystemProcessInstanceActivity( delicacy.system.bean.BaseSystemProcessInstanceActivity bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		SystemProcessInstanceActivity dao = new SystemProcessInstanceActivity();
		setConditions(bean, dao);
