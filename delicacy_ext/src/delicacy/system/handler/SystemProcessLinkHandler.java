...
public class SystemProcessLinkHandler implements GenericDao {
	...
	public static boolean isSystemProcessLinkExists( delicacy.system.bean.BaseSystemProcessLink bean, String additional ) throws Exception {
	...
	public static int countSystemProcessLink( delicacy.system.bean.BaseSystemProcessLink bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseSystemProcessLink> querySystemProcessLink( delicacy.system.bean.BaseSystemProcessLink bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		SystemProcessLink dao = new SystemProcessLink();
		setConditions(bean, dao);
