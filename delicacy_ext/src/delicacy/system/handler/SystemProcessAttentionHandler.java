...
public class SystemProcessAttentionHandler implements GenericDao {
	...
	public static boolean isSystemProcessAttentionExists( delicacy.system.bean.BaseSystemProcessAttention bean, String additional ) throws Exception {
	...
	public static int countSystemProcessAttention( delicacy.system.bean.BaseSystemProcessAttention bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseSystemProcessAttention> querySystemProcessAttention( delicacy.system.bean.BaseSystemProcessAttention bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		SystemProcessAttention dao = new SystemProcessAttention();
		setConditions(bean, dao);
