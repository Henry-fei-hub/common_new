...
public class DepartmentRoleWithRHandler implements GenericDao {
	...
	public static boolean isDepartmentRoleWithRExists( delicacy.system.bean.BaseDepartmentRoleWithR bean, String additional ) {
	...
	public static int countDepartmentRoleWithR( delicacy.system.bean.BaseDepartmentRoleWithR bean, String additional ) {
