...
public class SystemProcessTypeHandler implements GenericDao {
	...
	public static boolean isSystemProcessTypeExists( delicacy.system.bean.BaseSystemProcessType bean, String additional ) throws Exception {
	...
	public static int countSystemProcessType( delicacy.system.bean.BaseSystemProcessType bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseSystemProcessType> querySystemProcessType( delicacy.system.bean.BaseSystemProcessType bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		SystemProcessType dao = new SystemProcessType();
		setConditions(bean, dao);
